...
const ACCENT_STATUSES = new Set(['ACTIVE', 'APPROVED', 'DELIVERED', 'RESOLVED', 'BEING_CARED_FOR', 'FINISHING', 'READY_FOR_RETURN', 'ON_THE_WAY', 'QUALIFIED', 'paid', 'REDEEMED']);
const DANGER_STATUSES = new Set(['SUSPENDED', 'DEACTIVATED', 'DISPUTED', 'DELIVERY_FAILED', 'CANCELLED', 'OPEN']);
const BRASS_STATUSES = new Set(['REVIEW_PENDING', 'IDENTITY_PENDING', 'TRAINING_PENDING', 'APPLICATION_STARTED', 'PAUSED', 'SCHEDULED', 'PROVIDER_ASSIGNED', 'PENDING', 'UNREDEEMED']);
